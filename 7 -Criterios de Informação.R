...
MA2 <- arima(var_PIB, order = c(1,0,2))
MA3 <- arima(var_PIB, order = c(1,0,3))
MA4 <- arima(var_PIB, order = c(1,0,4))
MA5 <- arima(var_PIB, order = c(1,0,5))
MA6 <- arima(var_PIB, order = c(1,0,6))
MA7 <- arima(var_PIB, order = c(1,0,7))
MA8 <- arima(var_PIB, order = c(1,0,8))
MA9 <- arima(var_PIB, order = c(1,0,9))

ARMA12 <- arima(var_PIB, order = c(1,0,1))
ARMA13 <- arima(var_PIB, order = c(1,0,13))
ARMA14 <- arima(var_PIB, order = c(1,0,14))
ARMA15 <- arima(var_PIB, order = c(1,0,15))
ARMA16 <- arima(var_PIB, order = c(1,0,16))
ARMA17 <- arima(var_PIB, order = c(1,0,17))
ARMA18 <- arima(var_PIB, order = c(1,0,18))
ARMA19 <- arima(var_PIB, order = c(1,0,19))
